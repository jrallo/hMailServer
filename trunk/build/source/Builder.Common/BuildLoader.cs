...
namespace Builder.Common
{
    public class BuildLoader
    {
        public Builder Load(string s)
        {
            ...
            for (int i = 0; i < oBuildNode.ChildNodes.Count; i++)
            {
                ...
                if (sType == "writefile")
                    ...
                    AddActionCompileVS2005(oBuilder, oAction);
                else if (sType == "compilevs2008")
                    AddActionCompileVS2008(oBuilder, oAction);
        ...
        private void AddActionCompileVS2005(Builder oBuilder, XmlNode oNode)
        {
            string sFile = oNode.Attributes["filename"].Value;
         ...
         private void AddActionCompileVS2008(Builder oBuilder, XmlNode oNode)
         {
            string sFile = oNode.Attributes["filename"].Value;
            string sConfiguration = oNode.Attributes["configuration"].Value;
