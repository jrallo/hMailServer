namespace hMailServer.Administrator
{
    partial class ucDNSBlackList
    {
        ...
        private void InitializeComponent()
        {
			...
			// textExpectedResult
			// 
			this.textExpectedResult.Decimal = false;
			this.textExpectedResult.Location = new System.Drawing.Point(31, 91);
			this.textExpectedResult.Name = "textExpectedResult";
			this.textExpectedResult.Negative = false;
			this.textExpectedResult.Number = 0;
			this.textExpectedResult.Number64 = ((long)(0));
			this.textExpectedResult.NumberFloat = 0F;
			...
			// textDNSHost
			// 
			this.textDNSHost.Decimal = false;
			this.textDNSHost.Location = new System.Drawing.Point(31, 48);
			this.textDNSHost.Name = "textDNSHost";
			this.textDNSHost.Negative = false;
			this.textDNSHost.Number = 0;
			this.textDNSHost.Number64 = ((long)(0));
			this.textDNSHost.NumberFloat = 0F;
