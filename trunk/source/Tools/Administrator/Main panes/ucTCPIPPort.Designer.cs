namespace hMailServer.Administrator
{
    partial class ucTCPIPPort
    {
        ...
        private void InitializeComponent()
        {
			...
			this.checkStartTLS = new hMailServer.Administrator.Controls.ucCheckbox();
			...
			// checkStartTLS
			// 
			this.checkStartTLS.AutoSize = true;
			this.checkStartTLS.Location = new System.Drawing.Point(111, 150);
			this.checkStartTLS.Name = "checkStartTLS";
			this.checkStartTLS.Size = new System.Drawing.Size(90, 17);
			this.checkStartTLS.TabIndex = 36;
			this.checkStartTLS.Text = "Use StartTLS";
			this.checkStartTLS.UseVisualStyleBackColor = true;
			this.checkStartTLS.CheckedChanged += new System.EventHandler(this.checkStartTLS_CheckedChanged);
			// 
			// textIPAddress
			// 
			...
			this.checkEnableSSL.Location = new System.Drawing.Point(8, 150);
			...
			this.Controls.Add(this.checkStartTLS);
	   ...
	   private hMailServer.Administrator.Controls.ucCheckbox checkStartTLS;
    }
}
